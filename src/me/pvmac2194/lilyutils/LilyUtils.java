...
public class LilyUtils extends JavaPlugin implements Listener
	{
		...
		/**
		 * Gets a string of the players online, useful for /glist.
		 */
		public String getPlayersOnline()
			{
				GetPlayersRequest request = new GetPlayersRequest(true);
				FutureResult<GetPlayersResult> futureResult = null;
				try
					{
				...
				GetPlayersResult result = futureResult.awaitUninterruptibly();

				Set<String> s = result.getPlayers();
		...
		/**
		 * Gets the number of players on the network.
		 */
		public int getPlayersNumber()
			{
				...
				int number = result.getCurrentPlayers();
